...
#NOTE: Looks like they just used default OpenCV values for blocks / cells
#       But it looks like 4 cells per block is correct?
#       OpenCv also has levels as well

def modified_hog(image, orientations=9, pixels_per_cell=(8, 8),
